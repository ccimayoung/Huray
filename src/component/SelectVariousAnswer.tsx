...
export const SelectVariousAnswer = () => {
                    ...
                    if (
                      ...
                      return (
                        <ActiveClickBox
                          key={answerIndex}
                          onClick={() => {
                            // copy 배열을 만든다(push 사용위함)
                            // -> 선택한 답안을 누른경우 빈 배열로 교체, 선택하지 않은 답안일 경우 push한 배열로 교체
                            let copy = [
                              ...userAnswer[questionList.currentnumber].answer,
                            ];
                            if (copy.includes(answer)) {
                              copy = [];
                              setUserAnswer(
                                userAnswer.map((e, i) => {
